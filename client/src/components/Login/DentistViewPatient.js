...
import Patient from "../Table of Dentist/Patient";
...
// import 'bootstrap/dist/css/bootstrap.min.css';
// import Logo from '../image/Logo.png';
// import '../Css/Dentist Css/DentistViewPatient.css';
// const DentistViewPatient = ()=> {
//     return (
//       <div className="DentistViewPatient">
//         <header>
//           <div className="name-title">
//             <img src={Logo} alt="" />
//           </div>
...
//          <div class="table-heading">
//              <div class="table-data">Patient ID</div>
//              <div class="table-data">Full name</div>
//              <div class="table-data">Allergy</div>
//              <div class="table-data">Contradiction</div>             
//           </div>
//           <div class="table-row">
//              <div class="table-data"><a href="#">Patient ID</a></div>
//              <div class="table-data">Full name</div>
//              <div class="table-data">Allergy</div>
//              <div class="table-data">Contradiction</div>         </div>
//          <div class="table-row">
//              <div class="table-data"><a href="#">Patient ID</a></div>
//              <div class="table-data">Full name</div>
//              <div class="table-data">Allergy</div>
...
//     );
//   }
// export default DentistViewPatient;