...
import Staff from '../Table of Dentist/Staff';
...
// import 'bootstrap/dist/css/bootstrap.min.css';
// import Logo from '../image/Logo.png';
// import '../Css/Dentist Css/DentistViewStaff.css';

// const DentistViewStaff = ()=> {
//   const [data, setData] = useState([]);
//   useEffect(() => {
//     loadData();
//   }, []);  
//   const loadData = async () => {
//     try {
//       const response = await axios.get("http://localhost:5000/get-staff");
//       setData(response.data);
//       console.log(response.data); // In dữ liệu lấy từ API ra console
//     } catch (error) {
//       console.error(error); // Xử lý lỗi nếu có
...
//   };
//   return (
//     <div className="DentistViewStaff">
//       <header>
//         <div className="name-title">
//           <img src={Logo} alt="" />
//         </div>
...
//             <li class="nav-item"><a class="nav-link">Patients</a></li>
//             <li class="nav-item"><a class="nav-link" href="/DentistViewDentist">Dentist</a></li>
//             <li class="nav-item"><a class="nav-link" href="/DentistViewStaff"><span>Staff</span></a></li>
//             <li class="nav-item"><a class="nav-link" href="/DentistViewMedicine">Medicine</a></li>
//             <li class="nav-item"><a class="nav-link" href="/">Log out</a></li>
//           </ul>
//         </nav>
...
//            <div class="table-data">Phone Numer</div> 
//            <div class="table-data">Gender</div>
//         </div>
//         {data.map((item) =>(
//           <div key={item.UserID} className="table-row">
//             <div className="table-data">{item.UserID}</div>
...
//   );
// }
// export default DentistViewStaff;
